import { base, baseSepolia, polygon, bsc } from "viem/chains";
...
export const contractAddress = isBNBTest
  ? {
      BondingCurve: "0x4155cb24c5e2050d52cfFb3d0F580302028f8481" as Address,
      BABTValidatorAddress: "0x7a6e0fd3fCA26179c2342b59a2823fd269FB7f04" as Address,
      HaresFactory: "0xF1991A3d1B231F6Ae864c2C9f8a3Fa9b61557eA0" as Address,
...
export const EventTopic: Record<string, string> = {
  HaresTokenCreated: "0x1fc0f11aa4dadb735ee8cf1429a9b9cff9e67be8186df94a8a89193b03695365",
...
export const BondingCurveConfig = isBNBTest
  ? {
      A: 50000000,
      B: 1000000000,
    }
